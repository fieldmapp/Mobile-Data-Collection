    ...
    public class MockQuestionProvider : IStorageProvider
    {
        ...
        public List<IQuestionContent> CreateQuestionsForStadium()
        {
            ...
            return new List<IQuestionContent>
            {
                ...
                new QuestionStadiumPage(3, 1, "Stadium_one_question3.png", stadiums1.ToList(), plants1.ToList(), 1, "B"), // TODO: wrong picture needs replacement, ask Frau Truckenbrodt
                ...
                new QuestionStadiumPage(13, 3, "Stadium_three_question1.png", stadiums3.ToList(), plants3.ToList(), 2, "E"), // TODO: wrong picture needs replacement, ask Frau Truckenbrodt
