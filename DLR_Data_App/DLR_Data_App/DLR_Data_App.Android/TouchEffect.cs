...
namespace com.DLR.DLR_Data_App.Droid
{
    public class TouchEffect : PlatformEffect
    {
            ...
            switch (args.Event.ActionMasked)
            {
                ...
                case MotionEventActions.Move:
                    ...
                    for (pointerIndex = 0; pointerIndex < motionEvent.PointerCount; pointerIndex++)
                    {
                        ...
                        else
                        {
                            ...
                            if (idToEffectDictionary.TryGetValue(id, out var effect) && effect != null)
                            {
                                FireEvent(effect, id, TouchActionType.Moved, screenPointerCoords, true);
                            }
                        }
                    }
                    break;
                ...
                case MotionEventActions.Pointer1Up:
                    ...
                    else
                    {
                        ...
                        if (idToEffectDictionary.TryGetValue(id, out var effect) && effect != null)
                        {
                            FireEvent(effect, id, TouchActionType.Released, screenPointerCoords, false);
                        }
                    }
                ...
                case MotionEventActions.Cancel:
                    ...
                    else
                    {
                        if (idToEffectDictionary.TryGetValue(id, out var effect) && effect != null)
                        {
                            FireEvent(effect, id, TouchActionType.Cancelled, screenPointerCoords, false);
                        }
                    }
                    idToEffectDictionary.Remove(id);
                    break;
        ...
        { 
            ...
            if (idToEffectDictionary.TryGetValue(id, out var containedEffect) && touchEffectHit != containedEffect)
            {
                if (containedEffect != null)
                {
                    FireEvent(containedEffect, id, TouchActionType.Exited, pointerLocation, true);
                }
