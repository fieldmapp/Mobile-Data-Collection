...
namespace DlrDataApp.Modules.Profiling.Shared
{
    public static class ProfilingStorageManager
    {
        ...
        {
            return Database.FindWithChildren<ProfilingData>(r => r.ProfilingId == profilingId) != null;
        }
        ...
        {
            var savedProfilings = Database.ReadWithChildren<ProfilingResult>();
        ...
        public static void ExportAnswers()
        {
            ...
            using (var jsonWriter = new JsonTextWriter(streamWriter))
                JsonTranslator.JsonSerializer.Serialize(jsonWriter, results);
        }

        public static void ExportAnswers(ProfilingResults results)
        {
            if (!results.Results.Any())
                return;
